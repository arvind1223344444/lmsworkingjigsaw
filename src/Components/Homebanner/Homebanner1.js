...
export default function Homebanner() {
  ...
  const [ genderds, setGender] =useState('');
   ...
   const  usfdata={mobile:usnumber};
    //console.log(usfdata);
    // const res= await axios.postForm(`http://localhost/apis/otp/sent_otp.php`,usfdata)
    ...
    const verfiyotp =async(e)=>{
     ...
     //console.log(useOtp);
    //  const resp=await axios.postForm(`http://localhost/apis/otp/verify_otp.php`,psost);
    ...
    <div className="container">
      <div className="row align-items-center justify-content-between">
       ...
       {divsho ?
        ...
        {/* <form onSubmit={usSubmit} className="w-75 me-3"  >
        <input type="text" value={usnumber} onChange={(e)=>{Setusnumber(e.target.value)}}  className="form-control mb-3" placeholder="Enter your name"/>
        <input type="email" value={usnumber} onChange={(e)=>{Setusnumber(e.target.value)}}  className="form-control " placeholder="Enter your email"/>
