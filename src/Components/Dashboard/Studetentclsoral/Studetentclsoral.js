...
import {API_LIVECLASS__CLASS_ORAL_ASSIGNMENT_URL} from '../../../Services/api';
...
export default function Studetentclsoral() {
  ...
  const studenthomeWkqry =async()=>{
    ...
    const studenthomeWkqryqryresp= await axios.get(`${API_LIVECLASS__CLASS_ORAL_ASSIGNMENT_URL}/${user_id}`);
    ...
    <div className='col-md-9'>
        ...
        <div className='content'>
            <div className='section-title'>
                <h6 className='jig-title-style'>  Student Class Oral  </h6>
            </div>
